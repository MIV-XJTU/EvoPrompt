...
class WeldonPool2d(nn.Module):
    def __init__(self, kmax=1, kmin=None, **kwargs):
        ...
        print(
            "Using Weldon Pooling with kmax={}, kmin={}.".format(self.kmax, self.kmin)
        )
        ...
        class WeldonPool2dFunction(Function):
            ...
            def forward(ctx, input):
                ...
                if kmin > 0:
                    ...
                    output.add_(
                        sorted.narrow(2, n - kmin, kmin).sum(2).div_(kmin)
                    ).div_(2)
            ...
            def backward(ctx, grad_output):
                ...
                grad_input = (
                    grad_output.new()
                    .resize_(batch_size, num_channels, n)
                    .fill_(0)
                    .scatter_(2, indices_max, grad_output_max)
                    .div_(kmax)
                )
                ...
                if kmin > 0:
                    ...
                    grad_input_min = (
                        ...
                        .resize_(batch_size, num_channels, n)
                        .fill_(0)
                        .scatter_(2, indices_min, grad_output_min)
                        .div_(kmin)
                    )
