...
class ContinualScaler:
    """Loss and gradient scaler, useful for mixed precision training.
    Adopted from https://github.com/arthurdouillard/dytox/blob/main/continual/scaler.py
    """

    state_dict_key = "amp_scaler"

    def __init__(self, enable_amp: bool):
        self._scaler = torch.cuda.amp.GradScaler(enabled=enable_amp)
